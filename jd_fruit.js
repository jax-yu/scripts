/*
东东水果:脚本更新地址 https://github.com/zero205/JD_tencent_scf/blob/main/jd_fruit.js
1. 修改自定义相关配置
更新时间：2021-8-20
...
[task_local]
#jd免费水果
5 6-18/6 * * * https://github.com/zero205/JD_tencent_scf/blob/main/jd_fruit.js, tag=东东农场, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdnc.png, enabled=true
=========================Loon=============================
[Script]
cron "5 6-18/6 * * *" script-path=https://github.com/zero205/JD_tencent_scf/blob/main/jd_fruit.js,tag=东东农场
=========================Surge============================
东东农场 = type=cron,cronexp="5 6-18/6 * * *",wake-system=1,timeout=3600,script-path=https://github.com/zero205/JD_tencent_scf/blob/main/jd_fruit.js
=========================小火箭===========================
东东农场 = type=cron,script-path=https://github.com/zero205/JD_tencent_scf/blob/main/jd_fruit.js, cronexpr="5 6-18/6 * * *", timeout=3600, enable=true
...
let shareCodes = [ // 这个列表填入你要助力的好友的shareCode
  //账号一的好友shareCode,不同好友的shareCode中间用@符号隔开   助力未加入助力池的账号
  '75ba2ceffb0b40d590df81c378c617db@65bd45580cd94034a1b82e77d4e557eb',
  '75ba2ceffb0b40d590df81c378c617db@65bd45580cd94034a1b82e77d4e557eb',
  '75ba2ceffb0b40d590df81c378c617db@65bd45580cd94034a1b82e77d4e557eb',
  '75ba2ceffb0b40d590df81c378c617db@65bd45580cd94034a1b82e77d4e557eb',
  '75ba2ceffb0b40d590df81c378c617db@65bd45580cd94034a1b82e77d4e557eb',
...
async function doTenWaterAgain() {
  ...
  // 如果剩余水滴数大于快速浇水的水滴+配置的保留水滴则使用快速浇水卡
